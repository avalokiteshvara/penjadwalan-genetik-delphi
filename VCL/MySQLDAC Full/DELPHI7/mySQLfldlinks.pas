...
{ TFieldLink }
  ...
  TmySQLFieldLinkProperty = class(TStringProperty)
  private
    FChanged: Boolean;
    FDataSet: TDataSet;
  protected
...
{ TLink Fields }
  ...
  private
    ...
    FDataSetProxy: TmySQLFieldLinkProperty;
  ...
  public
    ...
    property DataSetProxy: TmySQLFieldLinkProperty read FDataSetProxy write FDataSetProxy;
    function Edit: Boolean;
  end;

function EditMasterFields(ADataSet: TDataSet; ADataSetProxy: TmySQLFieldLinkProperty): Boolean;
...
{ TmySQLFieldLinkProperty }

function TmySQLFieldLinkProperty.GetIndexBased: Boolean;
begin
  Result := False;
end;

function TmySQLFieldLinkProperty.GetIndexDefs: TIndexDefs;
begin
  Result := nil;
end;

function TmySQLFieldLinkProperty.GetIndexFieldNames: string;
begin
  Result := '';
end;

function TmySQLFieldLinkProperty.GetIndexName: string;
begin
  Result := '';
end;

procedure TmySQLFieldLinkProperty.GetIndexNames(List: TStrings);
var
  i: Integer;
begin
...
procedure TmySQLFieldLinkProperty.GetFieldNamesForIndex(List: TStrings);
begin
end;

procedure TmySQLFieldLinkProperty.SetIndexFieldNames(const Value: string);
begin
end;

procedure TmySQLFieldLinkProperty.SetIndexName(const Value: string);
begin
end;

function TmySQLFieldLinkProperty.GetAttributes: TPropertyAttributes;
begin
  Result := [paDialog];
end;

procedure TmySQLFieldLinkProperty.Edit;
begin
  FChanged := EditMasterFields(DataSet, Self);
  if FChanged then Modified;
end;

constructor TmySQLFieldLinkProperty.CreateWith(ADataSet: TDataSet);
begin
  FDataSet := ADataSet;
end;

function TmySQLFieldLinkProperty.GetDataSet: TDataSet;
begin
