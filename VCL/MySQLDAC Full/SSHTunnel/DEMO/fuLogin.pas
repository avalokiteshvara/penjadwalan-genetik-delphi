...
uses
  ...
  Dialogs, ActnList, ExtCtrls, ComCtrls, Spin, MySqlSSHDatabase, StdCtrls;
...
type
  ...
  private
    ...
    Database: TMySSHDatabase;
    function Edit: Boolean;
  public
    { Public declarations }
    procedure GetDatabaseProperty(Db: TMySSHDatabase);
    procedure SetDatabaseProperty(Db: TMySSHDatabase);
  end;

function ShowConnectDlg(ADatabase: TMySSHDatabase): Boolean;
...
procedure TfmLogin.GetDatabaseProperty(Db: TMySSHDatabase);
begin
  //Standard
...
procedure TfmLogin.SetDatabaseProperty(Db: TMySSHDatabase);
begin
  //Standard
